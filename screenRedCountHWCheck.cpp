...
void ScreenRedCountHWCheck::initDispWord(void)
{
    try
    {
        ...
        markRightWord[0].X = 8+80;
        markRightWord[0].Y = 2;
        markRightWord[1].X = 72+80;
        markRightWord[1].Y = 32;
        markRightWord[2].X = 72+80;
        markRightWord[2].Y = 72;
        markRightWord[3].X = 48+80;
        markRightWord[3].Y = 80;
        markRightWord[4].X = 8+80;
        markRightWord[4].Y = 72;
        markRightWord[5].X = 8+80;
        markRightWord[5].Y = 32;
        markRightWord[6].X = 48+80;
        markRightWord[6].Y = 40;

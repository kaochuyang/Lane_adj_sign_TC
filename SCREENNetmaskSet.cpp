...
void SCREENNetmaskSet::DisplayNetmask(void)
{
    try
    {
        ...
        value[0]=netmask1/100;
        value[1]=(netmask1%100)/10;
        value[2]=netmask1%10;
        value[3]=netmask2/100;
        value[4]=(netmask2%100)/10;
        value[5]=netmask2%10;
        value[6]=netmask3/100;
        value[7]=(netmask3%100)/10;
        value[8]=netmask3%10;
        value[9]=netmask4/100;
        value[10]=(netmask4%100)/10;
        value[11]=netmask4%10;
...
void SCREENNetmaskSet::DisplayGateway(void)
{
    try
    {
        ...
        value[0+12]=gateway1/100;
        value[1+12]=(gateway1%100)/10;
        value[2+12]=gateway1%10;
        value[3+12]=gateway2/100;
        value[4+12]=(gateway2%100)/10;
        value[5+12]=gateway2%10;
        value[6+12]=gateway3/100;
        value[7+12]=(gateway3%100)/10;
        value[8+12]=gateway3%10;
        value[9+12]=gateway4/100;
        value[10+12]=(gateway4%100)/10;
        value[11+12]=gateway4%10;

...
void ScreenPlanEditF2::doKey0Work(void)
{
    if(cSelPosition == 0)
    {
        ucPhaseTemp[cPosition-2] = 0;
        lcd240x128.DISPLAY_GRAPHIC_XY(planIdAndPhase[cPosition].X,planIdAndPhase[cPosition].Y,word8x16[0],planIdAndPhase[cPosition].height,planIdAndPhase[cPosition].width/8);
        doKeyRIGHTWork();
    }
    else if(cSelPosition == 1)
    {
        planTableTemp[cPosition] =   0;
        lcd240x128.DISPLAY_GRAPHIC_XY(planTable[cPosition].X,planTable[cPosition].Y,word8x16[0],planTable[cPosition].height,planTable[cPosition].width/8);
        doKeyRIGHTWork();
    }
    else if(cSelPosition == 2)
    {
        OffsetTemp[cPosition-4] = 0;
        lcd240x128.DISPLAY_GRAPHIC_XY(cycleAndOffset[cPosition].X,cycleAndOffset[cPosition].Y,word8x16[0],cycleAndOffset[cPosition].height,cycleAndOffset[cPosition].width/8);
        doKeyRIGHTWork();
    }
}
//---------------------------------------------------------------------------
void ScreenPlanEditF2::doKey1Work(void)
{
    if(cSelPosition == 0)
    {
        ucPhaseTemp[cPosition-2] = 1;
        lcd240x128.DISPLAY_GRAPHIC_XY(planIdAndPhase[cPosition].X,planIdAndPhase[cPosition].Y,word8x16[1],planIdAndPhase[cPosition].height,planIdAndPhase[cPosition].width/8);
        doKeyRIGHTWork();
    }
    else if(cSelPosition == 1)
    {
        planTableTemp[cPosition] =   1;
        lcd240x128.DISPLAY_GRAPHIC_XY(planTable[cPosition].X,planTable[cPosition].Y,word8x16[1],planTable[cPosition].height,planTable[cPosition].width/8);
        doKeyRIGHTWork();
    }
    else if(cSelPosition == 2)
    {
        OffsetTemp[cPosition-4] = 1;
        lcd240x128.DISPLAY_GRAPHIC_XY(cycleAndOffset[cPosition].X,cycleAndOffset[cPosition].Y,word8x16[1],cycleAndOffset[cPosition].height,cycleAndOffset[cPosition].width/8);
        doKeyRIGHTWork();
    }
}
//---------------------------------------------------------------------------
void ScreenPlanEditF2::doKey2Work(void)
{
    if(cSelPosition == 0)
    {
        ucPhaseTemp[cPosition-2] = 2;
        lcd240x128.DISPLAY_GRAPHIC_XY(planIdAndPhase[cPosition].X,planIdAndPhase[cPosition].Y,word8x16[2],planIdAndPhase[cPosition].height,planIdAndPhase[cPosition].width/8);
        doKeyRIGHTWork();
    }
    else if(cSelPosition == 1)
    {
        planTableTemp[cPosition] =   2;
        lcd240x128.DISPLAY_GRAPHIC_XY(planTable[cPosition].X,planTable[cPosition].Y,word8x16[2],planTable[cPosition].height,planTable[cPosition].width/8);
        doKeyRIGHTWork();
    }
    else if(cSelPosition == 2)
    {
        OffsetTemp[cPosition-4] = 2;
        lcd240x128.DISPLAY_GRAPHIC_XY(cycleAndOffset[cPosition].X,cycleAndOffset[cPosition].Y,word8x16[2],cycleAndOffset[cPosition].height,cycleAndOffset[cPosition].width/8);
        doKeyRIGHTWork();
    }
}
//---------------------------------------------------------------------------
void ScreenPlanEditF2::doKey3Work(void)
{
    if(cSelPosition == 0)
    {
        ucPhaseTemp[cPosition-2] = 3;
        lcd240x128.DISPLAY_GRAPHIC_XY(planIdAndPhase[cPosition].X,planIdAndPhase[cPosition].Y,word8x16[3],planIdAndPhase[cPosition].height,planIdAndPhase[cPosition].width/8);
        doKeyRIGHTWork();
    }
    else if(cSelPosition == 1)
    {
        planTableTemp[cPosition] =   3;
        lcd240x128.DISPLAY_GRAPHIC_XY(planTable[cPosition].X,planTable[cPosition].Y,word8x16[3],planTable[cPosition].height,planTable[cPosition].width/8);
        doKeyRIGHTWork();
    }
    else if(cSelPosition == 2)
    {
        OffsetTemp[cPosition-4] = 3;
        lcd240x128.DISPLAY_GRAPHIC_XY(cycleAndOffset[cPosition].X,cycleAndOffset[cPosition].Y,word8x16[3],cycleAndOffset[cPosition].height,cycleAndOffset[cPosition].width/8);
        doKeyRIGHTWork();
    }
}
//---------------------------------------------------------------------------
void ScreenPlanEditF2::doKey4Work(void)
{
    if(cSelPosition == 0)
    {
        ucPhaseTemp[cPosition-2] = 4;
        lcd240x128.DISPLAY_GRAPHIC_XY(planIdAndPhase[cPosition].X,planIdAndPhase[cPosition].Y,word8x16[4],planIdAndPhase[cPosition].height,planIdAndPhase[cPosition].width/8);
        doKeyRIGHTWork();
    }
    else if(cSelPosition == 1)
    {
        planTableTemp[cPosition] =   4;
        lcd240x128.DISPLAY_GRAPHIC_XY(planTable[cPosition].X,planTable[cPosition].Y,word8x16[4],planTable[cPosition].height,planTable[cPosition].width/8);
        doKeyRIGHTWork();
    }
    else if(cSelPosition == 2)
    {
        OffsetTemp[cPosition-4] = 4;
        lcd240x128.DISPLAY_GRAPHIC_XY(cycleAndOffset[cPosition].X,cycleAndOffset[cPosition].Y,word8x16[4],cycleAndOffset[cPosition].height,cycleAndOffset[cPosition].width/8);
        doKeyRIGHTWork();
    }
}
//---------------------------------------------------------------------------
void ScreenPlanEditF2::doKey5Work(void)
{
    if(cSelPosition == 0)
    {
        ucPhaseTemp[cPosition-2] = 5;
        lcd240x128.DISPLAY_GRAPHIC_XY(planIdAndPhase[cPosition].X,planIdAndPhase[cPosition].Y,word8x16[5],planIdAndPhase[cPosition].height,planIdAndPhase[cPosition].width/8);
        doKeyRIGHTWork();
    }
    else if(cSelPosition == 1)
    {
        planTableTemp[cPosition] =   5;
    ...
    {
        OffsetTemp[cPosition-4] = 5;
        lcd240x128.DISPLAY_GRAPHIC_XY(cycleAndOffset[cPosition].X,cycleAndOffset[cPosition].Y,word8x16[5],cycleAndOffset[cPosition].height,cycleAndOffset[cPosition].width/8);
        doKeyRIGHTWork();
    }
}
//---------------------------------------------------------------------------
void ScreenPlanEditF2::doKey6Work(void)
{
    if(cSelPosition == 0)
    {
        ucPhaseTemp[cPosition-2] = 6;
        lcd240x128.DISPLAY_GRAPHIC_XY(planIdAndPhase[cPosition].X,planIdAndPhase[cPosition].Y,word8x16[6],planIdAndPhase[cPosition].height,planIdAndPhase[cPosition].width/8);
        doKeyRIGHTWork();
    }
    else if(cSelPosition == 1)
    {
        planTableTemp[cPosition] =   6;
        lcd240x128.DISPLAY_GRAPHIC_XY(planTable[cPosition].X,planTable[cPosition].Y,word8x16[6],planTable[cPosition].height,planTable[cPosition].width/8);
        doKeyRIGHTWork();
    }
    else if(cSelPosition == 2)
    {
        OffsetTemp[cPosition-4] = 6;
        lcd240x128.DISPLAY_GRAPHIC_XY(cycleAndOffset[cPosition].X,cycleAndOffset[cPosition].Y,word8x16[6],cycleAndOffset[cPosition].height,cycleAndOffset[cPosition].width/8);
        doKeyRIGHTWork();
    }
}
//---------------------------------------------------------------------------
void ScreenPlanEditF2::doKey7Work(void)
{
    if(cSelPosition == 0)
    {
        ucPhaseTemp[cPosition-2] = 7;
        lcd240x128.DISPLAY_GRAPHIC_XY(planIdAndPhase[cPosition].X,planIdAndPhase[cPosition].Y,word8x16[7],planIdAndPhase[cPosition].height,planIdAndPhase[cPosition].width/8);
        doKeyRIGHTWork();
    }
    else if(cSelPosition == 1)
    {
        planTableTemp[cPosition] =   7;
        lcd240x128.DISPLAY_GRAPHIC_XY(planTable[cPosition].X,planTable[cPosition].Y,word8x16[7],planTable[cPosition].height,planTable[cPosition].width/8);
        doKeyRIGHTWork();
    }
    else if(cSelPosition == 2)
    {
        OffsetTemp[cPosition-4] = 7;
        lcd240x128.DISPLAY_GRAPHIC_XY(cycleAndOffset[cPosition].X,cycleAndOffset[cPosition].Y,word8x16[7],cycleAndOffset[cPosition].height,cycleAndOffset[cPosition].width/8);
        doKeyRIGHTWork();
    }
}
//---------------------------------------------------------------------------
void ScreenPlanEditF2::doKey8Work(void)
{
    if(cSelPosition == 0)
    {
        ucPhaseTemp[cPosition-2] = 8;
        lcd240x128.DISPLAY_GRAPHIC_XY(planIdAndPhase[cPosition].X,planIdAndPhase[cPosition].Y,word8x16[8],planIdAndPhase[cPosition].height,planIdAndPhase[cPosition].width/8);
        doKeyRIGHTWork();
    }
    else if(cSelPosition == 1)
    {
        planTableTemp[cPosition] =   8;
        lcd240x128.DISPLAY_GRAPHIC_XY(planTable[cPosition].X,planTable[cPosition].Y,word8x16[8],planTable[cPosition].height,planTable[cPosition].width/8);
        doKeyRIGHTWork();
    }
    else if(cSelPosition == 2)
    {
        OffsetTemp[cPosition-4] = 8;
        lcd240x128.DISPLAY_GRAPHIC_XY(cycleAndOffset[cPosition].X,cycleAndOffset[cPosition].Y,word8x16[8],cycleAndOffset[cPosition].height,cycleAndOffset[cPosition].width/8);
        doKeyRIGHTWork();
    }
}
//---------------------------------------------------------------------------
void ScreenPlanEditF2::doKey9Work(void)
{
    if(cSelPosition == 0)
    {
        ucPhaseTemp[cPosition-2] = 9;
        lcd240x128.DISPLAY_GRAPHIC_XY(planIdAndPhase[cPosition].X,planIdAndPhase[cPosition].Y,word8x16[9],planIdAndPhase[cPosition].height,planIdAndPhase[cPosition].width/8);
        doKeyRIGHTWork();
    }
    else if(cSelPosition == 1)
    {
        planTableTemp[cPosition] =   9;
        lcd240x128.DISPLAY_GRAPHIC_XY(planTable[cPosition].X,planTable[cPosition].Y,word8x16[9],planTable[cPosition].height,planTable[cPosition].width/8);
        doKeyRIGHTWork();
    }
    else if(cSelPosition == 2)
    {
        OffsetTemp[cPosition-4] = 9;
        lcd240x128.DISPLAY_GRAPHIC_XY(cycleAndOffset[cPosition].X,cycleAndOffset[cPosition].Y,word8x16[9],cycleAndOffset[cPosition].height,cycleAndOffset[cPosition].width/8);
        doKeyRIGHTWork();
    }
}
//---------------------------------------------------------------------------
void ScreenPlanEditF2::doKeyAWork(void)
{
    ...
    if(cSelPosition == 0)
    {
        ucPhaseTemp[cPosition-2] = 0xA;
        lcd240x128.DISPLAY_GRAPHIC_XY(planIdAndPhase[cPosition].X,planIdAndPhase[cPosition].Y,word8x16[0xA],planIdAndPhase[cPosition].height,planIdAndPhase[cPosition].width/8);
        doKeyRIGHTWork();
    }
    else
    {
...
void ScreenPlanEditF2::doKeyBWork(void)
{
    if(cSelPosition == 0)
    {
        ucPhaseTemp[cPosition-2] = 0xB;
        lcd240x128.DISPLAY_GRAPHIC_XY(planIdAndPhase[cPosition].X,planIdAndPhase[cPosition].Y,word8x16[0xB],planIdAndPhase[cPosition].height,planIdAndPhase[cPosition].width/8);
        doKeyRIGHTWork();
    }
}
//---------------------------------------------------------------------------
void ScreenPlanEditF2::doKeyCWork(void)
{
    if(cSelPosition == 0)
    {
        ucPhaseTemp[cPosition-2] = 0xC;
        lcd240x128.DISPLAY_GRAPHIC_XY(planIdAndPhase[cPosition].X,planIdAndPhase[cPosition].Y,word8x16[0xC],planIdAndPhase[cPosition].height,planIdAndPhase[cPosition].width/8);
        doKeyRIGHTWork();
    }
    else
    {
...
void ScreenPlanEditF2::doKeyDWork(void)
{
    if(cSelPosition == 0)
    {
        ucPhaseTemp[cPosition-2] = 0xD;
        lcd240x128.DISPLAY_GRAPHIC_XY(planIdAndPhase[cPosition].X,planIdAndPhase[cPosition].Y,word8x16[0xD],planIdAndPhase[cPosition].height,planIdAndPhase[cPosition].width/8);
        doKeyRIGHTWork();
    }
    else
    {
...
void ScreenPlanEditF2::doKeyEWork(void)
{
    if(cSelPosition == 0)
    {
        ucPhaseTemp[cPosition-2] = 0xE;
        lcd240x128.DISPLAY_GRAPHIC_XY(planIdAndPhase[cPosition].X,planIdAndPhase[cPosition].Y,word8x16[0xE],planIdAndPhase[cPosition].height,planIdAndPhase[cPosition].width/8);
        doKeyRIGHTWork();
    }
    else
    {
...
void ScreenPlanEditF2::doKeyFWork(void)
{
    if(cSelPosition == 0)
    {
        ucPhaseTemp[cPosition-2] = 0xF;
        lcd240x128.DISPLAY_GRAPHIC_XY(planIdAndPhase[cPosition].X,planIdAndPhase[cPosition].Y,word8x16[0xF],planIdAndPhase[cPosition].height,planIdAndPhase[cPosition].width/8);
        doKeyRIGHTWork();
    }
    else
    {

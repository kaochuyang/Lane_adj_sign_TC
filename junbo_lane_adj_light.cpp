...
//lcn=21951 zhuchon/wensin  lcn=21952  bright_6_rd/shen2   lcn21593=huko
        ...
        else
        {
            ...
            if(smem.GetAddress()==21951)//wensin/zhuchon
            {
                ...
                if((currenttime->tm_hour==6)&&(currenttime->tm_min>=59)&&(currenttime->tm_sec<10))
                {
                ...
                else if((currenttime->tm_hour>=7&&currenttime->tm_min>0)&&((currenttime->tm_hour<=8)&&(currenttime->tm_min<=59)&&currenttime->tm_sec<2))
                {
                ...
                else if((currenttime->tm_hour==8)&&(currenttime->tm_min>=59)&&(currenttime->tm_sec<10))
                {
                    /* junbo_light_send_reference_select(0x1,light_black);
                     junbo_light_send_reference_select(0x2,light_black);*/
                    select=1;
                ...
                else if((currenttime->tm_hour==16)&&(currenttime->tm_min>=59)&&(currenttime->tm_sec<10))
                {
                    /* junbo_light_send_reference_select(0x1,light_black);
                     junbo_light_send_reference_select(0x2,light_black);*/
                    select=1;
                ...
                else if((currenttime->tm_hour>=17&&currenttime->tm_min>0)&&((currenttime->tm_hour<=19)&&(currenttime->tm_min<=59)&&currenttime->tm_sec<2))
                {
                ...
                else if((currenttime->tm_hour==19)&&(currenttime->tm_min>=59)&&(currenttime->tm_sec<10))
                {
                    /* junbo_light_send_reference_select(0x1,light_black);
                     junbo_light_send_reference_select(0x2,light_black);*/
                    select=1;
            ...
            if(smem.GetAddress()==21952)//bright_6  shen_2
            {
                ...
                else if((currenttime->tm_hour>=17&&currenttime->tm_min>0)&&((currenttime->tm_hour<=20)&&(currenttime->tm_min<=29)&&currenttime->tm_sec<2))
                {
                ...
                else if((currenttime->tm_hour==20)&&(currenttime->tm_min>=29)&&(currenttime->tm_sec<10))
                {
                    /* junbo_light_send_reference_select(0x1,light_black);
                     junbo_light_send_reference_select(0x2,light_black);*/
                    select=1;

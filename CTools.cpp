...
unsigned char CTools::vGuessLightStep(const int iStep, unsigned char ucIn)
{
    try
    {
        ...
        case(5):
            ...
            {
                ucOutLight.block.b1 = true;
                ucOutLight.block.b2 = false;
            }
            break;

...
void ScreenSpecialDayEditF2::initDispWord(void)
{
    try
    {
        ...
        SpecialDayIDWord[0].X = 24;
        SpecialDayIDWord[0].Y = 98;
        SpecialDayIDWord[0].width=8;
        SpecialDayIDWord[0].height = 16;
        SpecialDayIDWord[1].X = 32;
        SpecialDayIDWord[1].Y = 98;
        SpecialDayIDWord[1].width=8;
        SpecialDayIDWord[1].height = 16;

        SegIDWord[0].X = 88;
        SegIDWord[0].Y = 113;
        SegIDWord[0].width=8;
        SegIDWord[0].height = 16;
        SegIDWord[1].X = 96;
        SegIDWord[1].Y = 113;
        SegIDWord[1].width=8;
        SegIDWord[1].height = 16;
...
bool ScreenSpecialDayEditF2::vCheck(void)
{
    ...
    {
        bool bRet = true;
        if(specialDaySegtype[iSeg-8]._start_year < 2000)
        {
            printf("printfMsg 1\n");
            bRet = false;
        }
        if(specialDaySegtype[iSeg-8]._end_year > 2037)
        {
            printf("printfMsg 2\n");
            bRet = false;
        }
        ...
        if(specialDaySegtype[iSeg-8]._start_month < 1)
        {
            printf("printfMsg 8\n");
            bRet = false;
        }
        if(specialDaySegtype[iSeg-8]._end_month > 12)
        {
            printf("printfMsg 9\n");
            bRet = false;
        }
        if(specialDaySegtype[iSeg-8]._start_day < 1)
        {
            printf("printfMsg 10\n");
            bRet = false;
        }
        if(specialDaySegtype[iSeg-8]._end_day > 31)
        {
            printf("printfMsg 11\n");
            bRet = false;
        }

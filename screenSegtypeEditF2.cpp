...
void ScreenSegtypeEditF2::doKey0Work(void)
{
    if(cSelect == 2)
    {
        ucSegmentWord[cPosition] = 0;
        lcd240x128.DISPLAY_GRAPHIC_XY(segmentWord[cPosition].X,segmentWord[cPosition].Y,word8x16[0],segmentWord[cPosition].height,segmentWord[cPosition].width/8);
        doKeyRIGHTWork();
    }
}
//---------------------------------------------------------------------------
void ScreenSegtypeEditF2::doKey1Work(void)
{
    if(cSelect == 2)
    {
        ucSegmentWord[cPosition] = 1;
        lcd240x128.DISPLAY_GRAPHIC_XY(segmentWord[cPosition].X,segmentWord[cPosition].Y,word8x16[1],segmentWord[cPosition].height,segmentWord[cPosition].width/8);
        doKeyRIGHTWork();
    }
}
//---------------------------------------------------------------------------
void ScreenSegtypeEditF2::doKey2Work(void)
{
    if(cSelect == 2)
    {
        ucSegmentWord[cPosition] = 2;
        lcd240x128.DISPLAY_GRAPHIC_XY(segmentWord[cPosition].X,segmentWord[cPosition].Y,word8x16[2],segmentWord[cPosition].height,segmentWord[cPosition].width/8);
        doKeyRIGHTWork();
    }
}
//---------------------------------------------------------------------------
void ScreenSegtypeEditF2::doKey3Work(void)
{
    if(cSelect == 2)
    {
        ucSegmentWord[cPosition] = 3;
        lcd240x128.DISPLAY_GRAPHIC_XY(segmentWord[cPosition].X,segmentWord[cPosition].Y,word8x16[3],segmentWord[cPosition].height,segmentWord[cPosition].width/8);
        doKeyRIGHTWork();
    }
}
//---------------------------------------------------------------------------
void ScreenSegtypeEditF2::doKey4Work(void)
{
    if(cSelect == 2)
    {
        ucSegmentWord[cPosition] = 4;
        lcd240x128.DISPLAY_GRAPHIC_XY(segmentWord[cPosition].X,segmentWord[cPosition].Y,word8x16[4],segmentWord[cPosition].height,segmentWord[cPosition].width/8);
        doKeyRIGHTWork();
    }
}
//---------------------------------------------------------------------------
void ScreenSegtypeEditF2::doKey5Work(void)
{
    if(cSelect == 2)
    {
        ucSegmentWord[cPosition] = 5;
        lcd240x128.DISPLAY_GRAPHIC_XY(segmentWord[cPosition].X,segmentWord[cPosition].Y,word8x16[5],segmentWord[cPosition].height,segmentWord[cPosition].width/8);
        doKeyRIGHTWork();
    }
}
//---------------------------------------------------------------------------
void ScreenSegtypeEditF2::doKey6Work(void)
{
    if(cSelect == 2)
    {
        ucSegmentWord[cPosition] = 6;
        lcd240x128.DISPLAY_GRAPHIC_XY(segmentWord[cPosition].X,segmentWord[cPosition].Y,word8x16[6],segmentWord[cPosition].height,segmentWord[cPosition].width/8);
        doKeyRIGHTWork();
    }
}
//---------------------------------------------------------------------------
void ScreenSegtypeEditF2::doKey7Work(void)
{
    if(cSelect == 2)
    {
        ucSegmentWord[cPosition] = 7;
        lcd240x128.DISPLAY_GRAPHIC_XY(segmentWord[cPosition].X,segmentWord[cPosition].Y,word8x16[7],segmentWord[cPosition].height,segmentWord[cPosition].width/8);
        doKeyRIGHTWork();
    }
}
//---------------------------------------------------------------------------
void ScreenSegtypeEditF2::doKey8Work(void)
{
    if(cSelect == 2)
    {
        ucSegmentWord[cPosition] = 8;
        lcd240x128.DISPLAY_GRAPHIC_XY(segmentWord[cPosition].X,segmentWord[cPosition].Y,word8x16[8],segmentWord[cPosition].height,segmentWord[cPosition].width/8);
        doKeyRIGHTWork();
    }
}
//---------------------------------------------------------------------------
void ScreenSegtypeEditF2::doKey9Work(void)
{
    if(cSelect == 2)
    {
        ucSegmentWord[cPosition] = 9;
        lcd240x128.DISPLAY_GRAPHIC_XY(segmentWord[cPosition].X,segmentWord[cPosition].Y,word8x16[9],segmentWord[cPosition].height,segmentWord[cPosition].width/8);
        doKeyRIGHTWork();
    }
}
//---------------------------------------------------------------------------
...
void ScreenSegtypeEditF2::doKeyDOWNWork(void)
{
    try
    {
        ...
        {
            clearCursor8x16(segmentWord[cPosition].X,segmentWord[cPosition].Y+16);
            if (cPosition>=0 && cPosition<=27)
            {
                cPosition+=14; //OT Debug 0523
            }
...
bool ScreenSegtypeEditF2::vCheckRationality(void)
{
    try
    {
        ...
        for(int i = 0; i < segment._segment_count; i++)
        {
            if( segment._ptr_seg_exec_time[i]._hour   > 23)
            {
                bRET = false;
                printf("printfMsg error at hour.\n");
            }
            if( segment._ptr_seg_exec_time[i]._minute > 59)
            {
                bRET = false;
                printf("printfMsg error at min.\n");
            }
            if( segment._ptr_seg_exec_time[i]._planid > 256)
            {
                bRET = false;
                printf("printfMsg error at planID.\n");
            }
        }
        ...
        */
        ...
        else
        {
            bRET = false;
            bRET = false;
            printf("printfMsg error at first seg.\n");
        }
        ...
        for(int i = 1; i < segment._segment_count; i++)
        {
            ...
            {
                if(segment._ptr_seg_exec_time[i-1]._minute >= segment._ptr_seg_exec_time[i]._minute)
                {
                    bRET = false;
                    printf("printfMsg error at cmp: %d %d %d.\n", i,segment._ptr_seg_exec_time[i-1]._hour,segment._ptr_seg_exec_time[i]._minute);
                }
            }
        }

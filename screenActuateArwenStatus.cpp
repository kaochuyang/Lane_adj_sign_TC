...
//testMark  if(bActTuningStatusNow == true) {
        ...
        if(bEnableModAdjGreenSec && iCurrentStep <= 2)
        {
            iAdjGreenSec+=1;
        }
...
//---------------
        for(int i = 0; i < 4; i++)
        {
            markSubPhase[i].width = 8;
            markSubPhase[i].height = 16;
            markStep[i].width = 8;
            markStep[i].height = 16;
        }
        ...
        for(int i = 0; i < 2; i++)
        {
            ...
            markOrgGreenTime[i].width = 8;
            markOrgGreenTime[i].height = 16;
            markAdjGreenTime[i].width = 8;
            markAdjGreenTime[i].height = 16;
            markMinGreenTime[i].width = 8;
            markMinGreenTime[i].height = 16;
        }
        for(int i = 0; i < 3; i++)
        {
            markMaxGreenTime[i].width = 8;
            markMaxGreenTime[i].height = 16;
        }

        markActSwitch.width = 8;
        markActSwitch.height = 16;
        markActTuning.width = 8;
        markActTuning.height = 16;
...
//---------------
        ...
        markActSwitch.X = 64;
        markActSwitch.Y = 28;
        markStepSecCount[0].X = 184;
        markStepSecCount[0].Y = 28;
        markStepSecCount[1].X = 192;
        markStepSecCount[1].Y = 28;
        markActTuning.X = 72;
        markActTuning.Y = 46;
        markOrgGreenTime[0].X = 72;
        markOrgGreenTime[0].Y = 68;
        markOrgGreenTime[1].X = 80;
        markOrgGreenTime[1].Y = 68;
        markAdjGreenTime[0].X = 184;
        markAdjGreenTime[0].Y = 68;
        markAdjGreenTime[1].X = 192;
        markAdjGreenTime[1].Y = 68;
        markMinGreenTime[0].X = 72;
        markMinGreenTime[0].Y = 88;
        markMinGreenTime[1].X = 80;
        markMinGreenTime[1].Y = 88;
        markMaxGreenTime[0].X = 152;
        markMaxGreenTime[0].Y = 88;
        markMaxGreenTime[1].X = 160;
        markMaxGreenTime[1].Y = 88;
        markMaxGreenTime[2].X = 168;
        markMaxGreenTime[2].Y = 88;

...
public:
    ...
    void ClearWord8X16(void)
    {
        for (int i=0; i<16; i++) word8x16Temp[i]=0;   //清空8x16暫存區
    }
    void ClearWord16X16(void)
    {
        for (int i=0; i<32; i++) word16x16Temp[i]=0;   //清空16x16暫存區
    }
    void ClearWord12X24(void)
    {
        for (int i=0; i<48; i++) word12x24Temp[i]=0;   //清空12x16暫存區
    }
    void ClearWord24X24(void)
    {
        for (int i=0; i<72; i++) word24x24Temp[i]=0;   //清空24x24暫存區
    }

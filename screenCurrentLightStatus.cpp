...
void ScreenCurrentLightStatus::initDispWord(void)
{
    try
    {
        ...
        for(int i = 0; i < 4; i++)
        {
            ...
            if(i<2)
            {
                markPhaseID[i].width = 8;
                markPhaseID[i].height = 16;
            }
            if(i<3)
            {
                markPlanID[i].width = 8;
                markPlanID[i].height = 16;
            }
...
//====================
        ...
        markPhaseID[1].X = 104;
        markPlanID[0].X = 200;
        markPlanID[1].X = 208, markPlanID[2].X = 216;
...
//    markSegTypeID[0].X = 88; markSegTypeID[1].X = 96;
        ...
        for(int i = 0; i < 4; i++)
        {
            markStepSecCount[i].Y = 84;
        }
        markStepSecCount[0].X = 72;
        markStepSecCount[1].X = 80;
        markStepSecCount[2].X = 88;
        markStepSecCount[3].X = 96;
